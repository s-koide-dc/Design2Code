...
3. [ACTION|LINQ|User|List<User>|NONE] [refs:step_2] [semantic_roles:{"property":"Name"}] [logic:[{"type":"string","operator":"StartsWith","variable_hint":"Name","expected_value":"A"},{"type":"conjunction","value":"AND"},{"type":"numeric","operator":"Greater","variable_hint":"Price","expected_value":500}]] 名前が 'A' で始まる、かつ価格が 500 より大きいユーザーを抽出する
...
- inference_fingerprint: 19ada7e165f154f95c3d0c55f17b2ae30cecfee407778b549e15e3c08db8484a
- assets:
