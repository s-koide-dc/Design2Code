...
主要経路は [ir_generator.py](../../../src/ir_generator/ir_generator.py#L243) 以降にある。
...
`ELSE` 句に入ると、[ir_generator.py](../../../src/ir_generator/ir_generator.py#L405) 付近で次が起きる。
...
次の else 側実ノードを作るとき、通常の chaining 規則 [ir_generator.py](../../../src/ir_generator/ir_generator.py#L243) がそのまま適用される。
