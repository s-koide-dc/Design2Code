...
# service_generation Design Document (Human Spec)

*This document is a template. When creating a new module, replace `service_generation` and fill in each section.*
